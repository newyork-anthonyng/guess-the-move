...
export function start(s, e) {
    // const predicate = !e.isTrusted || (e.button !== undefined && e.button !== 0);
    const predicate = (e.button !== undefined && e.button !== 0);
    console.group('%cdragStart', 'background-color: blue; color: white;');
